...
```bash
python "scripts/update_run_manifest.py" --project "[项目名]" --body draft_vN_illustrated.md --notes draft_vN_illustrated_notes.md --status illustrated --workflow-version collab-v2
```
