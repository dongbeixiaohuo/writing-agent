...
python "{{WRITING_AGENT_SCRIPTS}}/generate_clean.py" --stdout articles/[项目名]/[latest_body_file] > temp/reader_test_body.txt
...
```bash
python "{{WRITING_AGENT_SCRIPTS}}/update_run_manifest.py" --project "[项目名]" --body draft_vN.md --notes draft_vN_notes.md --status reader_test_revised --workflow-version collab-v2
```
